    ...
    while(numClocks>0){
        ...
        switch(opcode){                          //TODO debug cases
            ...
            case 0x10: //BPL relative
                ...
                pc += 2;
                if(((int8_t) status)>0){
                    if(pageCross(pc,pc + ((int8_t)arg0) )){ numClocks -= 1;} //new page penalty
                    pc += (int8_t) arg0; numClocks -= 1;
                }
                numClocks -= 2;
                break;
            case 0x11: //ORA indirect y
                ...
                setZ(acc);
                setN(acc);
                if(pageCross(pc,indirInd(arg0))){ numClocks -= 1;}
                numClocks -= 5;
                pc += 2;
                break;
            ...
            case 0x19: //ORA absolute y
                ...
                setZ(acc);
                setN(acc);
                if(pageCross(pc,arg0 + yindex)){ numClocks -= 1;}
                numClocks -= 4;
                pc += 3;
                break;
            case 0x1D: //ORA absolute x
                ...
                setZ(acc);
                setN(acc);
                if(pageCross(pc,arg0 + xindex)){ numClocks -= 1;}
                numClocks -= 4;
                pc += 3;
                break;
            ...
            case 0x75: //ADC zeropage x
                ...
                setZ(acc);
                setN(acc);
                if(pageCross(pc,zpageInd(arg0,xindex))){ numClocks -= 1;}
                numClocks -= 5;
                pc += 2;
                break;
